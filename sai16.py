...
cl = TOBY.LINE()
cl.login(token="EmuX15TYwABMTKeXFoW4.7UjGmIpz5BGNGC2pEuqUTa.SoXPzBYKuIhwDdb7YarMqbk92ATqlJQgI9/sBsLDYI4=")
cl.loginResult()
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~bot_botv13",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~bot_botv13",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
				...
				ki.sendText(msg.to,"line.me/ti/p/~bot_botv13")
