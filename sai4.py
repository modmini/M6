...
cl = LINETCR.LINE()
cl.login(token="Em1fbKi9bJivItZWc0s7.el+pyfO3HmPG60uhor9jTW.pKcY2gkFXEDV3UGUzTvoP5GqojPXlogJqckP1DcIi6o=")
cl.loginResult()
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u10bfcf605a3784ca60eb4507391f49b7"]
admsa = "u10bfcf605a3784ca60eb4507391f49b7"
admin = "u10bfcf605a3784ca60eb4507391f49b7"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':" รับติดบอทวี10\nรับติดบอทแท็กชื่อ\nรับทำไลน์สี\nรับทำปกชื่อ ป้ายทุกชนิด\nรัทำบอทคุยอัตโนมัติ\n",
    "lang":"JP",
    "comment":"""
Auto Like By.Dow
...
💫 1ชุด  ประกอบไปด้วย💫
 ...
 5.Rakko v10
 6.しりちゃん追加保護ボット7ตัว
 7.บอทคำสั่งภาษาไทย+บอทคุย

••••ราคา180฿ แบบไม่มีประกัน
        ราคา200฿ แบบมีประกัน

🍓ห้องเปล่าพร้อมบอท
••••ราคา100฿แบบไม่มีประกัน
        ราคา150฿แบบมีประกัน

🍓รับติดบอทเสริม
••••ราคาชุดละ100฿(1ชุดมี5ตัว) 

📓คุณสมบัติ"V10"📓
📝กันสมาชิกเปิดลิงค์ห้อง
📝กันสมาชิกเขิญคนนอกเข้ากลุ่ม
📝กันสมาชิกเปลี่ยนชื่อกลุ่ม 
📝กันสมาชิกเปลี่ยนรูปกลุ่ม
📝กันคนนอกเข้ามาลบสมาชิกในกลุ่ม 
ถ้าลบเกิน3คนบอทจะลบออกทันที
📝สามารถดูคนที่แอบอ่านข้อความที่คุณส่งในห้องได้
📝Bot V10สามารถมีแอดมินห้องได้2คน


🍓รับติดบอทแท็กชื่อ
 ••••ราคา300฿ไม่มีค่ารายเดือน

🍓รับทำบอทคุยออโต้ระบบAPIกำหนดคำ รูป ชื่อบอทได้เอง
••••ราคา200฿
