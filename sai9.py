...
cl = TOBY.LINE()
cl.login(token="EmuczLxj9rnUBM1gRqCf.Vnz4WEr4UV/kteu/uGsDVW.vMroM89BuepVgvHbwhrxzc0KObqx9l8Rk1/AatnDmO0=")
cl.loginResult()
...
creator=["ubcd678c1e478baff8a4c453e52049dbf"]
wait = {
    'contact':False,
    'autoJoin':"",
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"〖 ฿ΦŦ Šαї ₤℣ Ƽ.１.ƻ 〗\nรับติดตั้งBot V.10 Botแท็กชื่อ และBotทุกชนิด สนใจติดต่",
    "lang":"JP",
    "comment":"〖 ฿ΦŦ Šαї ₤℣ Ƽ.１.ƻ 〗\nรับติดตั้งBot V.10 Botแท็กชื่อ และBotทุกชนิด สนใจติดต่อแชท สต.",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["hgtmhdmvdbmbvmghmgmkjk"]:
					if wait["lang"] == "JP":
						cl.sendText(msg.to,helpMessage)
					else:
						cl.sendText(msg.to,helpt)

            elif "sai.000" in msg.text:
